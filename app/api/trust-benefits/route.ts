...
const defaults = [
  { id: 'free-shipping', title: 'Free Shipping', subtitle: 'On all orders across Pakistan', icon: 'truck', order: 1, active: true },
  ...
  { id: 'our-store', title: 'Our Location', subtitle: 'Iqbal Town, Lahore', icon: 'store', order: 4, active: true },
];
